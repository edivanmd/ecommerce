...
const Cart = ({ cart, onUpdateCartQuantity, onEmptyCart, onRemoveFromCart }) => {
    ...
    return (
        <Container>
            ...
            <Typography className={classes.title} variant="h3" gutterBottom>Your Sopping Cart</Typography>
